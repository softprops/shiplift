use super::{API_REFERENCE_URL, API_VERSION};
...
/// Internal implementation of (api_doc)[super::api_doc]
pub(crate) fn _api_doc(
    attr: TokenStream,
    item: TokenStream,
) -> TokenStream {
...
/// Arguments to [_api_doc](_api_doc)
struct Args {
...
/// All Item kinds that support being annotated by [_api_doc](_api_doc)
enum Item {
    Fn(ItemFn),
    Struct(ItemStruct),
}
